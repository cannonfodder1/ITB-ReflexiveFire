-- FURL is the Fully Unified Resource Loader and it makes adding 
-- Vek, Mech, and Weapon sprites and animations to the game simple!
...
local function setUpVek(mod,object)
	...
	if object.Animated        then ANIMS[name.."a"] =        ANIMS.EnemyUnit:new(addImage(object.Animated,"_a")) end
